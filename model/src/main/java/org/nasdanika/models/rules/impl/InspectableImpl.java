 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.rules.impl.InspectableImpl#getViolations <em>Violations</em>}</li>
...
public class InspectableImpl extends MinimalEObjectImpl.Container implements Inspectable {
	...
	public EList<Violation> getViolations() {
		return (EList<Violation>)eDynamicGet(RulesPackage.INSPECTABLE__VIOLATIONS, RulesPackage.Literals.INSPECTABLE__VIOLATIONS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RulesPackage.INSPECTABLE__VIOLATIONS:
